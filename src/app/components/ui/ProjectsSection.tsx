...
const projectData = [
    {
        ...
        description: 'Jobly is a interactive job and internship portal, providing wide range of functionalities.',
        image: 'https://sfmrqycwibsrxzmucyzr.supabase.co/storage/v1/object/public/project-images/Screenshot%202024-11-11%20165238.png'
    },
    {
        title: 'CampusHub - Android application for campus',
        description: 'CampusHub is a feature rich android application. It provides various functionalities for the students and faculties.',
        image: 'https://sfmrqycwibsrxzmucyzr.supabase.co/storage/v1/object/public/project-images/Screenshot%202024-04-07%20214227.png'
    }
];
