                ...
                content: (
                    <div>
                        <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
                            Built <span className="text-[#7364EB] ">Jobly</span>, a interactive job and internship platform. It has a strong & robust backend developed using Spring Boot framework..
                        </p>
                        <InteractiveHoverButton className="mb-2">Source Code</InteractiveHoverButton>
                ...
                content: (
                    <div>
                        <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal">
                            CampusHub is a one stop solution for all the campus problems & requirements.
                        </p>
                        <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
                            Want to share notes, attend live classes, mark attendances, create or join chat groups within the campus? Jobly is here to fulfill, all your desires..
                        </p>
                        <InteractiveHoverButton className="mb-2">Source Code</InteractiveHoverButton>
                        <div className="grid grid-cols-2 gap-4">
